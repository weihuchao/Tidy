...
if __name__ == '__main__':
    ...
    # move_mikan_download_files('/Users/weihc/Downloads/Mikan', '白莲花度假村第三季')
    # move_mikan_download_files('/Users/weihc/Downloads/Mikan', '圣女因太过完美不够可爱而被废除婚约并卖到邻国')
    # move_mikan_download_files('/Users/weihc/Downloads/Mikan', '瞬间治疗却被视为无用而被流放的天才治疗师，以暗黑治疗师的身份幸福地生活着')
    # move_mikan_download_files('/Users/weihc/Downloads/Mikan', '轉生為白豬貴族的我，運用前世記憶養育雛鳥般的弟弟')
    # move_mikan_download_files('/Users/weihc/Downloads/Mikan', '轉生成貓咪的大叔')
    # move_mikan_download_files('/Users/weihc/Downloads/Mikan', '无职转生')
    move_mikan_download_files('/Users/weihc/Downloads/Mikan', '9-nine- 支配者的王冠')
